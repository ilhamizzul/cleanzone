  ...
  <div id="banner" class="section-padding" >
    <div class="container">
      <div class="row">
        ...
        <h1 class="bold animated bounceInRight ">Clean Laundry</h1>        
        <hr>
        <p class="big animated  bounceInLeft">Pusat Laundry Terpercaya</p>
        <p class="big animated  bounceInRight">dan Berkualitas di Surabaya</p>
        <a id="landing-button" class="animated rubberBand" href="#about" role="presentation">Tell me more</a>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6" id="about-desc">
          <h1 class="cta-title bold "data-aos="fade-in">Tentang Clean</h1>
          <hr>
      ...
      <div class="row">
        ...
        <div class="form-sec">
          <form action="" method="post" role="form" class="contactForm">
            <div class="col-md-4 col-md-offset-2 form-group right">
              <input type="text" name="name" class="form-control text-field-box "style="float:right;" id="name" placeholder="ID Invoice" data-rule="minlen:4" data-msg="Data Orderan Anda Tidak Di Temukan" />
        ...
        <div style="visibility: visible; animation-name: zoomIn;" class="col-md-6 text-center wow zoomIn">
          ...
          <div class="footer_social">
           <a href="https://play.google.com/store/apps/details?id=relaxtudio.clean.dropzone">
              <img src="<?php echo base_url() ?>assets/img/client/gp.png" class="gp">
           </a>
           <a href="https://play.google.com/store/apps/details?id=com.ss.android.ugc.trill&hl=in">
              <img src="<?php echo base_url() ?>assets/img/client/as.png" class="as">
          </a> 
          </div>
       </div>
        <!--- END COL -->
